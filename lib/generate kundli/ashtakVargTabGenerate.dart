...
class AshtakVargTabGenerate extends StatefulWidget {
  final kundaliList;
  const AshtakVargTabGenerate({Key? key,this.kundaliList}) : super(key: key);

  @override
  _AshtakVargTabGenerateState createState() => _AshtakVargTabGenerateState();
}

class _AshtakVargTabGenerateState extends State<AshtakVargTabGenerate> {
